...
<body>
    ...
    <div>
        <?php
            ...
            $edit_prod = "UPDATE produto SET nomeproduto='$nome', usuario_idusuario='$idusu' WHERE idproduto = '$id'";
            $editar_prod = mysqli_query($conn,$edit_prod);
            echo "PRODUTO EDITADO!";
        ?>
        <a href="prodlista.php">Retornar</a>
    </div>
</body>
</html>