...
<body>
    ...
    <div>
        <?php
            ...
            if($perm != 1){
                echo "VOCÊ NÃO TEM PERMISSÃO PARA APAGAR USUÁRIOS<br>";
            }else{
                $apag = $_POST["numerousuario"];

                $apagar_usuario = "DELETE FROM usuario WHERE idUser = '$apag'";
                $apagar_usuario = mysqli_query($conn, $apagar_usuario);
                echo "USUÁRIO APAGADO!<br>";
            }
        ?>
    </div>
    <div><a href="apagarusuario.php">RETORNAR</a></div>
</body>
</html>