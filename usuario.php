...
<body>
    ...
    <form action="processausuario.php" method="post">
        <input type="text" name="nomeusuario" id="" placeholder="nome"><br>
        <input type="text" name="email" id="" placeholder="email"><br>
        <input type="text" name="senha" id="" placeholder="senha"><br>
        <input type="number" name="perm" id="" min="0" max="1"><br>
