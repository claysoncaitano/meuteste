...
<body>
    ...
    $resultado_produto = "INSERT INTO produto (nomeproduto, usuario_idusuario) VALUES ('$nome','$id')";
    $resultado_produto = mysqli_query($conn, $resultado_produto);

    echo "PRODUTO CADASTRADO";}
    ?>
    <div><a href="prod.php">RETORNAR</a></div>
</div>
</body>
</html>