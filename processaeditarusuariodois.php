...
<body>
    ...
    <div>
        <?php
            ...
            $editar_usuario = "UPDATE usuario SET Username='$nome', email='$email', Password='$senha', Permissao='$permissao' WHERE idUser = '$id'";
            $edit_usuario = mysqli_query($conn,$editar_usuario);
            echo "USUÁRIO EDITADO!";
        ?>
        <a href="usuariolista.php">Retornar</a>
    </div>
</body>
</html>