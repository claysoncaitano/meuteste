...
<body>
    ...
    <div>
        <?php
            ...
            $mostrarprodutos = mysqli_query($conn, $mostrarprodutos);
            echo "<table>";
            echo "<tr><td>id </td><td>nome</td><td>usuario</td><td>Editar</td></tr>";
            while($row = mysqli_fetch_array($mostrarprodutos)){
                echo "<tr><td>" . htmlspecialchars($row['idproduto']) . "</td><td>" . htmlspecialchars($row['nomeproduto']) . "</td><td>" . htmlspecialchars($row['usuario_idusuario']) . "</td><td>" . "<a href='processaeditarprod.php?id=" . $row['idproduto'] ."'>Editar</a>" . "</td></tr>";
            }
            echo "</table>";
        ?>
     </div>
